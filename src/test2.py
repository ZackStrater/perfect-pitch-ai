...
for filename in os.listdir('/media/zackstrater/Samsung_T5/maestro-v3.0.0/2013'):
    if filename.endswith(".midi"):
        # print(os.path.join(directory, filename))
        print(filename)
        # import midi file, result is a list of strings that contain midi actions
        csv_string = pm.midi_to_csv(os.path.join('/media/zackstrater/Samsung_T5/maestro-v3.0.0/2013', filename))
        ...
        if filename.endswith(".wav"):
            y, sr = librosa.load(os.path.join('/media/zackstrater/Samsung_T5/maestro-v3.0.0/2013', filename), sr=None)
            print(sr)
        pass
