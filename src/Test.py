...
new_song.process_audio_midi_save_slices('../data', '../data', normalize_mel_spectrogram=True, n_mels=128, stepsize=10, left_buffer=100, right_buffer=27, filename='44100hz')
