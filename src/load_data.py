...
model = Sequential()
model.add(Conv2D(filters=50, kernel_size=(5, 1), padding='valid', input_shape=(128, 70, 1)))
model.add(Activation('relu'))
model.add(Conv2D(filters=50, kernel_size=(3, 1), padding='valid'))
model.add(Activation('relu'))
model.add(MaxPooling2D(pool_size=(2, 2)))
model.add(Conv2D(filters=25, kernel_size=(3, 1), padding='valid'))
model.add(Activation('relu'))
model.add(MaxPooling2D(pool_size=(2, 2)))
model.add(Flatten())
